...
## Fork Changes (inoma-tech/claude-code-action@beta)
...
- **Updated Base Action**: Uses `inoma-tech/claude-code-base-action@beta` which includes OAuth credential handling
